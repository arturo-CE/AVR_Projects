...
*   the middle of three LEDs on PB0, PB1, and PB2 is lit.The LEDs light for 300 ms each in sequence. 
*   When the button is pressed, the currently lit LED stays lit. Pressing the button again restarts the game. 
 *
